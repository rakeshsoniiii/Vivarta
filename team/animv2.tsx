...
function Team() {
  ...
  // Domain Leads (excludes Point of Contact)
  const roboticsLeads = teams.filter(
    (member) => member.domain === 'Robotics' && member.designation === 'Domain Lead'
  );
  const funEventsLeads = teams.filter(
    (member) => member.domain === 'Fun Events' && member.designation === 'Domain Lead'
  );
  const gamingLeads = teams.filter(
    (member) => member.domain === 'Gaming' && member.designation === 'Domain Lead'
  );
  const innovationAndManagementLeads = teams.filter(
    (member) =>
      member.domain === 'Innovation and Management' &&
      member.designation === 'Domain Lead'
  );
  const mechmaniaLeads = teams.filter(
    (member) => member.domain === 'Mechmania' && member.designation === 'Domain Lead'
  );
  const designingLeads = teams.filter(
    (member) => member.domain === 'Designing' && member.designation === 'Domain Lead'
  );
  const publicRelationsLeads = teams.filter(
    (member) =>
      member.domain === 'Public & Relations' && member.designation === 'Domain Lead'
  );
  const computingLeads = teams.filter(
    (member) => member.domain === 'Computing' && member.designation === 'Domain Lead'
  );

  // Point of Contacts (excludes Domain Lead)
  const roboticsPOCs = teams.filter(
    (member) => member.domain === 'Robotics' && member.designation === 'Point of Contact'
  );
  const funEventsPOCs = teams.filter(
    (member) =>
      member.domain === 'Fun Events' && member.designation === 'Point of Contact'
  );
  const gamingPOCs = teams.filter(
    (member) => member.domain === 'Gaming' && member.designation === 'Point of Contact'
  );
  const innovationAndManagementPOCs = teams.filter(
    (member) =>
      member.domain === 'Innovation and Management' &&
      member.designation === 'Point of Contact'
  );
  const mechmaniaPOCs = teams.filter(
    (member) => member.domain === 'Mechmania' && member.designation === 'Point of Contact'
  );
  const designingPOCs = teams.filter(
    (member) => member.domain === 'Designing' && member.designation === 'Point of Contact'
  );
  const publicRelationsPOCs = teams.filter(
    (member) =>
      member.domain === 'Public & Relations' && member.designation === 'Point of Contact'
  );
  const computingPOCs = teams.filter(
    (member) => member.domain === 'Computing' && member.designation === 'Point of Contact'
  );
    ...
    <div>
      ...
      <section className="teams-section">
        <div className="container mx-auto pt-7">
          ...
          <h3
            className="mb-9 text-center text-3xl font-extrabold leading-tight"
            data-aos="zoom-in"
          ...
          {/* Robotics POCs Section */}
          {roboticsPOCs.length > 0 && (
            <>
              <h5 className="mb-6 text-center text-lg font-bold text-blue-600" data-aos="fade-right" data-aos-duration="800">Robotics</h5>
              <div className="animate__animated animate__fadeIn team-row mb-12">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {roboticsPOCs.map((teamMember) => (
                    <Card
                      key={teamMember._id}
                      className="flex flex-col items-center justify-center transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/10"
                      data-aos="fade-right"
                    ...
                    >
                      ...
                      <CardContent className="flex flex-col items-center justify-center text-center">
                        ...
                        <div className="mt-3 flex gap-3">
                          ...
                          {teamMember.facebook && (
                            <Link href={teamMember.facebook} target="_blank" rel="noopener noreferrer">
                              <FaFacebook size={20} />
                            </Link>
                          )}
                          {teamMember.instagram && (
          ...
          {/* Fun Events POCs Section */}
          {funEventsPOCs.length > 0 && (
            <>
              <h5 className="mb-6 text-center text-lg font-bold text-green-600" data-aos="fade-left" data-aos-duration="800">Fun Events</h5>
              <div className="animate__animated animate__fadeIn team-row mb-12">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {funEventsPOCs.map((teamMember) => (
                    <Card
                      key={teamMember._id}
                      className="flex flex-col items-center justify-center transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/10"
                      data-aos="fade-left"
          ...
          {/* Innovation and Management POCs Section */}
          {innovationAndManagementPOCs.length > 0 && (
            <>
              <h5
                className="mb-6 text-center text-lg font-bold text-orange-600"
                data-aos="fade-up"
                data-aos-duration="800"
              >
              ...
              <div className="animate__animated animate__fadeIn team-row mb-12">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {innovationAndManagementPOCs.map((teamMember) => (
                    <Card
                      key={teamMember._id}
                      className="flex flex-col items-center justify-center transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/10"
                      data-aos="fade-up"
          ...
          {/* Mechmania POCs Section */}
          {mechmaniaPOCs.length > 0 && (
            <>
              <h5 className="mb-6 text-center text-lg font-bold text-red-600" data-aos="zoom-in" data-aos-duration="800">Mechmania</h5>
              <div className="animate__animated animate__fadeIn team-row mb-12">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {mechmaniaPOCs.map((teamMember) => (
                    <Card
                      key={teamMember._id}
                      className="flex flex-col items-center justify-center transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/10"
                      data-aos="zoom-in"
          ...
          {/* Designing POCs Section */}
          {designingPOCs.length > 0 && (
            <>
              <h5 className="mb-6 text-center text-lg font-bold text-pink-600" data-aos="fade-up-left" data-aos-duration="800">Designing</h5>
              <div className="animate__animated animate__fadeIn team-row mb-12">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {designingPOCs.map((teamMember) => (
                    <Card
                      key={teamMember._id}
                      className="flex flex-col items-center justify-center transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/10"
                      data-aos="fade-up-left"
          ...
          {/* Public & Relations POCs Section */}
          {publicRelationsPOCs.length > 0 && (
            <>
              <h5 className="mb-6 text-center text-lg font-bold text-teal-600" data-aos="zoom-in" data-aos-duration="800">Public & Relations</h5>
              <div className="animate__animated animate__fadeIn team-row mb-12">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {publicRelationsPOCs.map((teamMember) => (
                    <Card
                      key={teamMember._id}
                      className="flex flex-col items-center justify-center transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/10"
                      data-aos="zoom-in"
          ...
          {/* Computing POCs Section */}
          {computingPOCs.length > 0 && (
            <>
              <h5 className="mb-6 text-center text-lg font-bold text-blue-600" data-aos="fade-down" data-aos-duration="800">Computing</h5>
              <div className="animate__animated animate__fadeIn team-row mb-12">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  {computingPOCs.map((teamMember) => (
                    <Card
                      key={teamMember._id}
                      className="flex flex-col items-center justify-center transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/10"
                      data-aos="fade-down"
